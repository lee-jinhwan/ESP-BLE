 ...
 */
bool BLEAdvertisedDevice::equals(BLEAdvertisedDevice otherDevice) {
	return getAddress() == otherDevice.getAddress();
} // equals

bool BLEAdvertisedDevice::operator==(const BLEAdvertisedDevice& otherDevice) const {
	return m_address == otherDevice.m_address;
}
